...
export function run(text) {
    try {
        ...
        // ssf.ElementExt.parse(
        //     app_hwnd,
        //     "/Custom[1]/Custom/Custom/Custom[2]/Custom/Custom[6]",
        //     5000,
        // ).click();

        ssf.ElementExt.parse(app_hwnd,'/Custom[2]/Custom[13]/Custom[6]/Custom[2]/Custom[1]/Button[5]',5000).click()
    } catch (error) {
        console.log(error);
    }
}
